...
// Non-owning, validated compressed-tensors NVFP4 view. Backing storage must
// remain alive AND immutable for the lifetime of this view and its slices.
// Construction checks positive dimensions, K % 16, byte lengths, overflow,
// and finite nonnegative block / finite positive global scales.
